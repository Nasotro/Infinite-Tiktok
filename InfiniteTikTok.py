...
def get_description_pictures(story):
    ...
    For example, if the sentence is : a man is eating a sandwich, you can say a picture of a man eating a sandwich, becasue it's very likely that there is a picture of a man eating a sandwich that exists online, whereas if the sentence is : a beatiful pig wearing yellow pants, this is very unlikely that this exact picture exists online, therefore you should decompose the sentence in two parts : one for the pig, and one for the yellow pants.
    Please chose the most images as possible (go for it !) and if a sentence needs more than one image, you can split the sentence in two or more parts.
...
def create_video_from_text(text, video_name = None, background_video_path = 'videos\\satifying\\satisfying.mp4', output_name = None):
    ...
    video = video.subclip(0, timing_description.duration+2)
    new_width_ratio = 1/3
...
From that day forward, Momo became a friend to the butterflies. She played with them among the flowers, chasing their delicate dance but never trying to catch them. Momo's patience and understanding had turned her dream into reality, proving that sometimes, the best way to play is to let the game come to you."""
    ...
    text6 = """I once found a peculiar, antique pocket watch at a dusty old flea market. The seller, an elderly woman with a mysterious smile, told me it had the power to stop time. Intrigued, I bought it, more for its charm than its supposed magical abilities. One day, in the midst of a chaotic workday, I jokingly wound the watch and wished for everything to pause. To my astonishment, the world around me froze. People were suspended mid-step, cars halted in mid-air, and even the raindrops hung motionless. I moved around in this silent, still world, marveling at the sight. I visited places I'd always wanted to see, read books I'd never had time for, and even had a quiet dinner in a bustling restaurant, all in the span of my frozen lunch hour. But as I enjoyed my solitude, I also felt a pang of loneliness. The world was beautiful, but it was empty without the laughter, the arguments, the hustle and bustle of life. I realized then that time, even when chaotic, was precious because it was filled with experiences and people. With newfound appreciation, I unwound the pocket watch, and the world sprang back to life. The chaos returned, but so did the laughter, the conversations, and the shared experiences. I decided then, that I would never stop time again."""
    text7 = """Have you ever wondered what happens when you accidentally summon a genie in the 21st century? ??????? Let me tell you, it's not all wishes and dreams. ??So, I was just chilling in my room, trying out this new 'magic lamp' prop I got for my TikTok videos. Suddenly, a puff of smoke and BOOM! ?? There's a genie in my room, looking super offended. ??'Who are you?' I asked, trying not to freak out. 'I'm Jim, your genie,' he said, rolling his eyes. ?? 'You rubbed the lamp, now you get three wishes. Let's get this over with.'I was like, 'Okay, cool. First, I want a million dollars.' ?? Jim snapped his fingers and... nothing happened. He looked at his fingers, confused. 'Huh, that's weird. Maybe the magic needs a reboot. Try again tomorrow.' ??Next day, I wished for the same thing. Jim snapped his fingers, and... still nothing. ?? He scratched his head, 'Maybe it's because money doesn't grow on trees anymore. Try something else.'So, I wished for world peace. ????? Jim snapped his fingers, and... you guessed it, nothing happened. He threw up his hands, 'Look, kid, I don't know what's going on. Maybe it's because the world is more complicated now.'Finally, I wished for something simple - a pizza. ?? Jim snapped his fingers, and... my doorbell rang. There was a pizza delivery guy outside. 'That'll be $20,' he said. I looked at Jim, and he just shrugged, 'Hey, at least it's something.'So, what happens when you accidentally summon a genie in the 21st century? You end up with a pizza and a genie with a tech support issue. ??????"""
    text8 = """Have you ever wondered what happens when you reply to a wrong number? ???? One sunny afternoon, I received a text meant for someone else. 'Hey, it's me. I'm outside.' ?? I decided to have some fun. 'Me who?' I replied. The mystery texter played along. 'Guess...' ?? We exchanged witty banter, and I found myself laughing out loud. After a few minutes, they confessed, 'Okay, you got me. I don't know who you are, but this was fun. Who are you?' ?? I smiled and typed, 'Just a wrong number, having a right conversation.' ?? So, what happens when you reply to a wrong number? Sometimes, you make a friend. ??"""
    create_video_from_text(text8, 'wrong-number', 'videos\\brackgrounds\\yellow_matrix.mp4')
